...
class Schedules(models.Model):
    ...
    collaborating_group = models.ForeignKey(GroupNames,on_delete=models.CASCADE, blank=True, null=True, related_name="schedule_group_id")
...
class ToDoLists(models.Model):
    ...
    collaborating_group = models.ForeignKey(GroupNames, on_delete=models.CASCADE, blank=True, null=True, related_name="todolist_group_id")
    memo = models.TextField(blank=True, null=True)
...
class Assignments(models.Model):
    ...
    collaborating_group = models.ForeignKey(GroupNames, on_delete=models.CASCADE, blank=True, null=True, related_name="assignment_group_id")
    memo = models.TextField(blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    user = models.ForeignKey(Users, on_delete=models.CASCADE)
